...
# sleep 3
# avrdude -v -patmega32u4 -cavr109 -P$PORT -Uflash:w:../../lets_split_rev2_jimmy2.hex
avrdude -v -patmega32u4 -cavr109 -P$PORT -Uflash:w:../../lets_split_rev2_default.hex
